...
CREATE SEQUENCE IF NOT EXISTS SEQ_PASSWORD_RESET   START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS SEQ_PERMISO          START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS SEQ_TRIAJE           START WITH 100 INCREMENT BY 1;
...
CREATE TABLE IF NOT EXISTS TRIAJE (
    ID_TRIAJE           BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ID_CITA             BIGINT        NOT NULL,
    ID_ENFERMERA        BIGINT,
    FECHA_TRIAJE        TIMESTAMP     DEFAULT CURRENT_TIMESTAMP NOT NULL,
